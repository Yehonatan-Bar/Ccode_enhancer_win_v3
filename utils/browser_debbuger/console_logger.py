...
def console_logger(url, kill_existing=True):
    ...
    try:
        ...
        # Add a set to track unique messages
        unique_messages = set()
                ...
                if data.get('method') in ['Runtime.consoleAPICalled', 'Console.messageAdded']:
                    ...
                    if data['method'] == 'Runtime.consoleAPICalled':
                        ...
                        if msg:
                            ...
                            # Only add message if it's unique
                            if formatted_msg not in unique_messages:
                                unique_messages.add(formatted_msg)
        ...
        if input("Do you want to close the browser? (y/n): ").lower() != 'y':
            ...
            return console_messages  # Return only the console messages
...
if __name__ == '__main__':
    try:
        ...
        logs = console_logger(url)
        # Only print the unique console messages at the end
